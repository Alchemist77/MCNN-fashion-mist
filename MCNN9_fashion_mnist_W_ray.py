...
NUM_CLASSES = 10
EARLY_STOPPING = 25
OUTPUT_DIR = 'outputs/output_MCNN/'
...
class MCNN(nn.Module):
    def __init__(self):
        ...
        backbone_layers.append(ConvBlock(in_channels=1, out_channels=256))
        ...
        backbone_layers.append(ConvBlock(in_channels=192, out_channels=256))
        backbone_layers.append(ConvBlock(in_channels=256, out_channels=32))
        backbone_layers.append(ConvBlock(in_channels=32, out_channels=192))
        backbone_layers.append(nn.MaxPool2d(kernel_size=2))
        backbone_layers.append(ConvBlock(in_channels=192, out_channels=192))
...
# # # get optimizer
optimizer = optim.Adam(model.parameters(), lr=0.001563329349637658)
...
np.savetxt("loss/MCNN9_train.txt", train_loss_data, delimiter=',')
np.savetxt("loss/MCNN9_test.txt", val_loss_data, delimiter=',')
np.savetxt("accuracy/MCNN9_train.txt", train_accuracy_data, delimiter=',')
np.savetxt("accuracy/MCNN9_test.txt", val_accuracy_data, delimiter=',')

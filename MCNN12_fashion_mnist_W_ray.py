...
class MCNN(nn.Module):
    def __init__(self):
        ...
        backbone_layers.append(ConvBlock(in_channels=32, out_channels=128))
        ...
        backbone_layers.append(ConvBlock(in_channels=192, out_channels=64))
        backbone_layers.append(ConvBlock(in_channels=64, out_channels=128))
        backbone_layers.append(ConvBlock(in_channels=128, out_channels=32))
        ...
        backbone_layers.append(ConvBlock(in_channels=192, out_channels=32))
...
# # # get optimizer
optimizer = optim.Adam(model.parameters(), lr=0.00020600061539343008)
...
np.savetxt("loss/MCNN_train.txt", train_loss_data, delimiter=',')
np.savetxt("loss/MCNN_test.txt", val_loss_data, delimiter=',')
np.savetxt("accuracy/MCNN_train.txt", train_accuracy_data, delimiter=',')
np.savetxt("accuracy/MCNN_test.txt", val_accuracy_data, delimiter=',')
